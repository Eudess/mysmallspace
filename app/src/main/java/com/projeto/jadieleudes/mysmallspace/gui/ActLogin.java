...
import com.projeto.jadieleudes.mysmallspace.infra.Animacao;
...
public class ActLogin extends AppCompatActivity {
     ...
     * @param view - Referência ao Botão Logar @see {@link View} e {@link com.projeto.jadieleudes.mysmallspace.R.layout}.
     */
    ...
    private void irTelaHome(){
        Intent it = new Intent(ActLogin.this, ObtendoLocalizacao.class);
        startActivity(it);
        finish();
    }
}